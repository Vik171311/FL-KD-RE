...
# MODEL_ZOO = ['resnet18','resnet18_2','resnet34','resnet34_2']
MODEL_ZOO = ['resnet18','resnet34','resnet34_2','resnet34_3','resnet34_4']

MODEL_BLOCKS = {
    'resnet18': ['layer1.0', 'layer1.1', 'layer2.0', 'layer2.1',
                 'layer3.0', 'layer3.1', 'layer4.0', 'layer4.1'],
    'resnet18_2': ['layer1.0', 'layer1.1', 'layer2.0', 'layer2.1',
                 'layer3.0', 'layer3.1', 'layer4.0', 'layer4.1'],
    'resnet34': ['layer1.0', 'layer1.1', 'layer1.2', 'layer2.0',
                 'layer2.1', 'layer2.2', 'layer2.3', 'layer3.0',
                  'layer3.1', 'layer3.2', 'layer3.3', 'layer3.4',
                  'layer3.5', 'layer4.0', 'layer4.1', 'layer4.2'],
    'resnet34_2': ['layer1.0', 'layer1.1', 'layer1.2', 'layer2.0',
                 'layer2.1', 'layer2.2', 'layer2.3', 'layer3.0',
                  'layer3.1', 'layer3.2', 'layer3.3', 'layer3.4',
                  'layer3.5', 'layer4.0', 'layer4.1', 'layer4.2'],
    'resnet34_3': ['layer1.0', 'layer1.1', 'layer1.2', 'layer2.0',
                 'layer2.1', 'layer2.2', 'layer2.3', 'layer3.0',
                  'layer3.1', 'layer3.2', 'layer3.3', 'layer3.4',
                  'layer3.5', 'layer4.0', 'layer4.1', 'layer4.2'],
    'resnet34_4': ['layer1.0', 'layer1.1', 'layer1.2', 'layer2.0',
                 'layer2.1', 'layer2.2', 'layer2.3', 'layer3.0',
                  'layer3.1', 'layer3.2', 'layer3.3', 'layer3.4',
                  'layer3.5', 'layer4.0', 'layer4.1', 'layer4.2'],
...
MODEL_PRINT = {
    ...
    'resnet34': 'ResNet34',
    'resnet34_2': 'ResNet34_2',
    'resnet34_3': 'ResNet34_3',
    'resnet34_4': 'ResNet34_4'
...
MODEL_STATS = {
    'resnet18': dict(arch='resnet18', top1=69.758, param=11.69, backend='pytorch', type='cnn'),
    # 'resnet18_2': dict(arch='resnet18_2', top1=69.758, param=11.69, backend='pytorch', type='cnn'),
    'resnet34': dict(arch='resnet34', top1=69.758, param=11.69, backend='pytorch', type='cnn'),
    # 'resnet34_2': dict(arch='resnet34_2', top1=69.758, param=11.69, backend='pytorch', type='cnn')
}
